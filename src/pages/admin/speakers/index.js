    ...
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Grid container spacing={2} alignItems='center'>
          <Grid item xs={8}>
            <Typography variant='h5'>Ponentes</Typography>
          </Grid>
      ...
      </Grid>
      {
        currentSpeakers.map((speaker) => (
          <Grid key={`speakers_${speaker.id}`} item xs={12} md={4}>
            <Card sx={{ p: 4 }}>
              <CardContent sx={{ p: 0, '&:last-child': { paddingBottom: 0 } }}>
                ...
                <Grid item xs={12} align='center'>
                    ...
                    >
                      <Avatar src={speaker.imageUrl} component={RouterLink} to={`edit/${speaker.id}`} sx={{ height: '100%', width: '100%' }} />
                    </Box>
                  </Grid>
                  <Grid item xs={12}>
